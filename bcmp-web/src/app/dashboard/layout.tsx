...
export default function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-background relative overflow-hidden">
      ...
      <Sidebar />
      <div className="flex-1 flex flex-col min-w-0 relative z-10 overflow-x-hidden overflow-y-auto h-screen">
        <Header />
        <main className="flex-1">
          <div className="max-w-[1600px] mx-auto px-6 md:px-8 py-6">{children}</div>
        </main>
        {/* Footer */}
        <footer className="border-t border-border px-6 py-3 text-[11px] text-muted-foreground/60 flex items-center justify-between">
          <span>&copy; 2015-2026 All Rights Reserved &middot; Built by <a href="https://primex.ventures/" target="_blank" rel="noopener noreferrer" className="font-semibold text-muted-foreground/80 hover:text-blue-500 transition-colors">PrimeX Ventures Inc.</a></span>
