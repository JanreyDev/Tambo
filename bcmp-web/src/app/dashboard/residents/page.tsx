...
export default function ResidentsPage() {
  ...
  const [openSections, setOpenSections] = useState<OpenSectionsState>({
    ...
    pets: false,
    emergency: false, verification: false, biometric: false,
  });
  ...
  const openCreate = () => {
    ...
    setOpenSections({ other: false, education: false, work: false, govinfo: false, pets: false, emergency: false, verification: false, biometric: false });
  ...
  const openEdit = (r: ResidentDetail) => {
    ...
    setOpenSections({ other: true, education: true, work: true, govinfo: true, pets: true, emergency: true, verification: true, biometric: true });
