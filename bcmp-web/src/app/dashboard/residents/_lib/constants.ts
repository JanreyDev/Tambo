...
export const sectorOptions = ["4Ps Beneficiary", "Barracks", "Farmer", "IP (Indigenous People)", "JODA Driver", "Kasambahay", "LGBTQIA+", "Minor", "Nano/Micro Entrepreneur", "OFW", "Other Driver", "PWD", "Senior Citizen", "Solo Parent", "Student", "TODA Driver", "Vendor", "With Comorbidities", "Working Student"];
